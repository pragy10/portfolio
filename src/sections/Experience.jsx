  ...
  const experiences = [
    {
      ...
      description:
        "Leading object detection and quality assessment development for smart road infrastructure monitoring system.",
      achievements: [
      ...
      highlights: [
        {
          icon: FiCamera,
          text: "Real-time road monitoring",
          color: "text-blue-400",
        },
        {
          icon: FiCpu,
          text: "Multi-model AI pipeline",
          color: "text-green-400",
        },
        {
          icon: FiMapPin,
          text: "Geospatial metadata",
    ...
    },
    {
      ...
      status: "Ongoing",
      description:
        "Developing QueryCraft, an enterprise Text-to-SQL system allowing analysts to query HPE NonStop server performance data using natural language.",
      achievements: [
        "Engineered the end-to-end pipeline using FastAPI, React, PostgreSQL, and Google Gemini API",
        "Implemented semantic caching with ChromaDB to reduce API costs and improve response times",
        "Enforced strict database security using SQLGlot AST validation for read-only query execution",
      ],
      techStack: [
        "FastAPI",
        "React",
      ...
      highlights: [
        {
          icon: FiDatabase,
          text: "Enterprise Text-to-SQL",
          color: "text-blue-400",
        },
        { icon: FiCpu, text: "Semantic Caching", color: "text-green-400" },
        { icon: FiShield, text: "AST Validation", color: "text-purple-400" },
        {
          icon: FiServer,
          text: "HPE NonStop Telemetry",
          color: "text-orange-400",
        },
      ],
      workflow: [
        "Natural language query input",
        "Semantic caching check via ChromaDB",
        "SQL generation & AST security validation",
        "Read-only execution & dynamic reporting",
      ],
      role: "CPP Intern",
    ...
    },
    {
      id: 3,
      type: "Internship",
      title: "CV and AI Dataset Intern",
      company: "Ecomotive Smart Solutions",
      period: "Dec 2024 – Feb 2025",
      status: "Completed",
      description:
        "Developed custom computer vision datasets and optimized object detection models to automate localized municipal waste segregation pipelines.",
      achievements: [
        "Sourced and categorized a custom image dataset of Indian municipal solid waste across 5 distinct classes",
        "Categorized data into hard plastics, soft plastics, bottles, cans, and general waste",
        "Trained and optimized a computer vision object detection model to improve automated waste segregation accuracy",
      ],
      techStack: [
        "Computer Vision",
        "Object Detection",
      ...
      highlights: [
        {
          icon: FiCamera,
          text: "Custom Waste Dataset",
          color: "text-blue-400",
        },
        { icon: FiLayers, text: "5 Distinct Classes", color: "text-green-400" },
        { icon: FiTarget, text: "Object Detection", color: "text-purple-400" },
        {
          icon: FiRefreshCw,
          text: "Automated Segregation",
          color: "text-orange-400",
        },
      ],
      workflow: [
        "Waste image sourcing & collection",
        "5-class data categorization",
        "Model training & optimization",
        "Segregation pipeline integration",
      ],
      role: "CV & AI Intern",
    ...
    },
    {
      ...
      description:
        "Providing comprehensive design solutions and technical expertise for vehicle technology startup.",
      achievements: [
    ...
    },
    {
      ...
      description:
        "Co-hosted a 2.5 hour ML session, diving into two different real-world problem statements to give participants a smooth yet deep introduction on ML in space",
      achievements: [
    ...
    },
    {
      ...
      description:
        "Accepted into the CrftHQ Fellowship, a 60-day, student-led accelerator that empowers student builders to turn their ideas into impactful products, brands, and ventures.",
      achievements: [
      ...
      highlights: [
        ...
        {
          icon: FiGift,
          text: "Access to ₹92.6 Cr+ in tech credits & perks",
          color: "text-green-400",
        },
        {
          icon: FiUsers,
          text: "Mentorship from IIT/IIM grads, Fortune 500 pros, and founders",
          color: "text-purple-400",
        },
        {
          icon: FiTv,
          text: "24-hour televised finale with investors & VCs",
          color: "text-orange-400",
        },
      ],
      workflow: ["Ideation", "Validation", "MVP", "Go-To-Market"],
      role: "Fellow",
      color: "from-blue-500 to-cyan-500",
      bgColor: "bg-blue-500/10",
    },
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Real-world experience through hackathons, startup contributions, and
                    ...
                    <div className="lg:col-span-2 space-y-6">
                      ...
                      <div className="flex items-start justify-between">
                        <div>
                          <div className="flex items-center gap-3 mb-2">
                            <span
                              className={`px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-r ${experiences[activeCard].color} text-white`}
                            >
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {experiences[activeCard].workflow.map(
                            (step, index) => (
                              <motion.div
                                key={index}
                      ...
                      <div>
                        ...
                        <ul className="space-y-3">
                          {experiences[activeCard].achievements.map(
                            (achievement, index) => (
                              <motion.li
                                key={index}
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <div className="space-y-3">
                          {experiences[activeCard].highlights.map(
                            (highlight, index) => (
                              <motion.div
                                key={index}
                              ...
                              >
                                <highlight.icon
                                  className={`${highlight.color} flex-shrink-0`}
                                  size={20}
                                />
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {experiences[activeCard].techStack.map(
                            (tech, index) => (
                              <motion.span
                                key={index}
                                initial={{ opacity: 0, scale: 0.8 }}
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex justify-between text-sm">
                            ...
                            <span className="text-teal-400 font-medium">
                              {experiences[activeCard].techStack.length}+
                            </span>
                          </div>
                        </div>
                      </div>
